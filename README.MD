# Tienda Sicnet
Tienda SICnet es un proyecto de ecommerce básico para una casa de computación y venta de artículos informáticos. Esta aplicación te permite ver una lista de productos disponibles en la tienda y realizar compras en línea. Los productos y las órdenes de compra se almacenan en Firebase, lo que proporciona una experiencia de compra segura y confiable.
